...
if __name__=="__main__":
    parser = ArgumentParser(description="Perform time evolution for excited-state adiabatic state preparation in molecular system")
    ...
    hmat, dip_hmat = quantum.get_2nd_quant_hamiltonian(system.mo_ints, system.nmo, eps)
    ...
    # Number of qubits for the system Hamiltonian, used for the photon projection
    nqubit = nmo*2
    ...
    if trotter and noisy:
        Eks, Pks = quantum.trotter_evolve_noisy_dm(path, n, nmo*2, hamil_terms, dt, vk)
